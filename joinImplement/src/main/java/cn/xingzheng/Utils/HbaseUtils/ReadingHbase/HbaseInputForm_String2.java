...
public class HbaseInputForm_String2 extends CustomTableInputFormat<Tuple2<String, String>>{

    private String tableNameString = "t2";
    private String startRow = null;
    private String endRow = null;

    public HbaseInputForm_String2 setStartRow(String startRow) {
        this.startRow = startRow;
        return this;
    }

    public HbaseInputForm_String2 setEndRow(String endRow) {
        this.endRow = endRow;
        return this;
    }
