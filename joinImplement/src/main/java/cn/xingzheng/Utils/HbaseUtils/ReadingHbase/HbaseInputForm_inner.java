...
public class HbaseInputForm_inner extends CustomTableInputFormat<Tuple1<NAME>> {

    private String tableNameString = "name";
    private String startRow = null;
    private String endRow = null;

    public HbaseInputForm_inner setStartRow(String startRow) {
        this.startRow = startRow;
        return this;
    }

    public HbaseInputForm_inner setEndRow(String endRow) {
        this.endRow = endRow;
        return this;
    }
     ...
     */
    @Override
    protected Tuple1<NAME> mapResultToTuple(Result r) {
        ...
        return Tuple1.of(new NAME(rowKey, values));
    }
